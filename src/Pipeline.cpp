...
PhongShadingPass::PhongShadingPass(PassSetting *passSetting) : Pass(passSetting), m_outputFrameTextureId(0),
    ...
    PhongShadingPassSetting *phongPassSetting = (PhongShadingPassSetting *) passSetting;
...
void PhongShadingPass::renderPass(const std::vector<ShadeObject *> &shadingList) {
    ...
    PhongShadingPassSetting *setting = (PhongShadingPassSetting *) m_passSetting;
...
void DefferedGBufferPass::renderPass(const std::vector<ShadeObject *> &shadingList) {
    ...
    DefferedShadingPassSetting *setting = (DefferedShadingPassSetting *) m_passSetting;
...
DefferedShadingPass::DefferedShadingPass(PassSetting *passSetting) : Pass(passSetting), m_outputFrameTextureId(0),
    ...
    DefferedShadingPassSetting *defferedShadingPassSetting = (DefferedShadingPassSetting *) passSetting;
...
void DefferedShadingPipeline::setupPipeline() {
    ...
    shadingSetting = new DefferedShadingPassSetting();
    shadingSetting->m_projectionMatrix = glm::perspective(glm::radians(m_camera->m_fov * 2.0f),
                                                          (float) m_camera->m_width / (float) m_camera->m_height,
                                                          0.1f, 100.0f);
    shadingSetting->m_viewMatrix = glm::lookAt(
